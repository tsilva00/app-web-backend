...
namespace app_web_backend.Controllers
{
    public class DadosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Email,Senha,CEP,Done")] Dados dados)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Id,Nome,Email,Senha,CEP")] Dados dados)
        {
            if (id != dados.Id)
            {
                return NotFound();
